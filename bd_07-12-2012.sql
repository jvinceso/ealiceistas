...
CREATE TABLE `profesional_servicio` (
  ...
  PRIMARY KEY  (`nProId`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=latin1 COMMENT='5';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2012-12-07 21:12:09
